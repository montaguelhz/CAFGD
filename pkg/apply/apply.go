...
func (applier *Applier) Run() (err error) {
	...
	result, err = simulator.Simulate(clusterResource, selectedResourceList, applier.cluster.PodCluster, simulator.WithSchedulerConfig(applier.schedulerConfig), simulator.WithKubeConfig(applier.cluster.KubeConfig), simulator.WithCustomConfig(applier.customConfig))
	if err != nil {
		return err
	}
